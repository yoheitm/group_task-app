...
| 3 | スケジュール管理機能 | グループでスケジュールを共有できるようにする | グループの中のユーザー全員が同じスケジュールを共有できる | ・登録したイベントは後から編集、削除できる<br>・登録したイベントはグループのページ上に一覧表示される| 8 |
...
## グループ機能
ユーザーは登録しているユーザーから参加者を選択してグループを作成できます。<br>また、作成されたグループには後から参加することができて、参加中のグループからは退出もできます。他のグループに移動することとなった場合や間違えてメンバーを選んでしまった場合なども柔軟に対応できます。<br>
...
## スケジュール管理機能
グループの参加者は、作成したグループに紐づくイベントを登録できます。<br>登録されたイベントは、グループの参加者全員が編集・削除できます。<br>
...
## メッセージ機能
グループに所属しているユーザー達にメッセージを送ることができます。<br>
グループページではスケジュール画面とメッセージ画面を切り替えることができます。<br>イベントの登録・変更・確認の連絡をグループ内で出来るのでスケジュールを共有し易くなります。<br>
